...
export const ProductCard: React.FC<ProductCardProps> = ({ product, isSelectedForCompare, onToggleCompare }) => {
    ...
    return (
        <div className="group [perspective:1000px] h-full">
            <div className="relative bg-background rounded-lg border border-border flex flex-col transition-all duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(10deg)] h-full shadow-md hover:shadow-2xl">
                ...
                <div className="relative">
                    ...
                    <div 
                        className="absolute top-2 right-2 z-20 bg-white/80 backdrop-blur-sm p-2 rounded-lg flex items-center cursor-pointer"
                    ...
                    >
                        ...
                        />
                        <label className="ml-2 text-xs font-semibold text-text-DEFAULT select-none cursor-pointer">Compare</label>
                    </div>
                </div>
                <div className="p-6 flex flex-col flex-grow">
                    ...
                    <div className="mb-4 border-t border-border pt-3">
                        <h4 className="text-xs font-bold text-text-secondary uppercase mb-2">Key Specs</h4>
