...
const Downloads = () => {
    return (
        <section id="downloads" className="border-t border-slate-200 bg-slate-50" role="region" aria-label="Downloads">
            <div className="mx-auto max-w-7xl px-4 py-16">
            <h2 className="text-3xl font-bold">{DOWNLOADS_DATA.title}</h2>
            <ul className="mt-6 space-y-3 text-sm font-semibold text-blue-600">
