        ...
        <>
            ...
            <main className="container py-12 md:py-20">
                ...
                <ScrollReveal delay={300} className="mt-12">
                    ...
                    <ul className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6 text-lg">
                        <li className="flex items-start gap-4 p-4 rounded-lg bg-card/50">
                            <Droplets className="mt-1 h-6 w-6 shrink-0 text-foreground/60" />
                            <div>
                        ...
                        <li className="flex items-start gap-4 p-4 rounded-lg bg-card/50">
                            <Wind className="mt-1 h-6 w-6 shrink-0 text-foreground/60" />
                             <div>
                        ...
                        <li className="flex items-start gap-4 p-4 rounded-lg bg-card/50">
                            <Sun className="mt-1 h-6 w-6 shrink-0 text-foreground/60" />
                             <div>
                        ...
                        <li className="flex items-start gap-4 p-4 rounded-lg bg-card/50">
                            <Zap className="mt-1 h-6 w-6 shrink-0 text-foreground/60" />
                             <div>
                         ...
                         <li className="flex items-start gap-4 p-4 rounded-lg bg-card/50 md:col-span-2">
                            <ShieldCheck className="mt-1 h-6 w-6 shrink-0 text-foreground/60" />
                             <div>
                ...
                <ScrollReveal delay={400}>
                    <p className="mt-12 text-lg bg-primary/5 border-l-4 border-foreground/60 p-6 rounded-r-lg text-foreground">
