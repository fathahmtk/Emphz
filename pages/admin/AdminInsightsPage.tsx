    ...
    const handleDelete = async (postId: number, postTitle: string) => {
        if (window.confirm(`Are you sure you want to delete "${postTitle}"?`)) {
            try {
                ...
                addToast(t('toasts.deleteSuccess').replace('{name}', postTitle), 'success');
    ...
    return (
        <div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
                <h1 className="text-2xl sm:text-3xl font-bold text-text-DEFAULT dark:text-slate-200">Manage Insights (Blog)</h1>
                <button 
