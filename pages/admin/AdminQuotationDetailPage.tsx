    ...
    return (
        <div>
            ...
            <div className="mb-6 flex flex-col sm:flex-row justify-between items-center gap-4">
                <NavLink to="/admin/quotations" className="flex items-center text-accent dark:text-accent hover:underline font-semibold self-start">
                ...
                <div className="flex gap-4 self-end sm:self-auto">
                        ...
                        className="bg-primary text-white px-4 py-2 rounded-lg font-semibold hover:bg-primary-dark shadow-sm transition-all duration-300 flex items-center"
                    >
