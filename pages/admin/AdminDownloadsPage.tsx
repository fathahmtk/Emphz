                                    ...
                                    <tr key={download.id} className="bg-white dark:bg-slate-800 border-b dark:border-slate-700 hover:bg-background-light dark:hover:bg-slate-700/50">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex space-x-4">
                                                <button onClick={() => handleEdit(download)} className="text-accent hover:text-accent-hover"><Edit size={18}/></button>
                                                <button onClick={() => handleDelete(download.id, download.title)} className="text-danger hover:opacity-80"><Trash size={18}/></button>
                                            </div>
                                        </td>
                                    </tr>
                                ))
